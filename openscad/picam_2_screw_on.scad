...
module picam2_holes( beam_length=15){
	...
	union(){
		//chamfer the bottom of the camera cut-out
        hull(){
        ...
        intersection(){
            ...
            translate([0,0,camera[2]]) hole_from_bottom(r=hole_r, h=beam_length, base_w=99);
        }
...
module camera_mount(){
    ...
    rotate(45) difference(){
        ...
        translate([0,0,bottom]) picam2_holes();
    }
}
camera_mount();
